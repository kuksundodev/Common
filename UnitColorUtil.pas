...
//파스텔 계열 색상(Color)을 랜덤하게 반환
//RGB 각 채널을 127~255 범위로 제한
//이렇게 하면 전체적으로 밝고 부드러운(파스텔) 색이 됨
function RandomPastelColor: TColor;
//색 편차를 줄여서 더 부드럽게
function RandomPastelColorSoft: TColor;
//Hue만 랜덤, 밝기는 고정 → 더 예쁜 파스텔
function RandomPastelColorHSL: TColor;
